...
<form action="<?php echo JRoute::_('index.php?option=com_thorhospedaje&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="state-form" class="form-validate form-horizontal">
	<div class="row-fluid">
		<!-- Begin country -->
	...
	<fieldset>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="details">
				...
				<div class="control-group">
					<div class="control-label"><?php echo $this->form->getLabel('state_desc'); ?></div>
					<div class="controls"><?php echo $this->form->getInput('state_desc'); ?></div>
				</div>
				<div class="control-group">
