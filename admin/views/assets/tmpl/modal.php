...
<div id="filter-bar" class="btn-toolbar">
	...
	<div class="btn-group pull-left">
		<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" size="30" title="<?php echo JText::_('TH_ASSETS_FILTER_SEARCH_DESC'); ?>" />
	</div>
	<div class="btn-group pull-left">
