...
<div class="span9">
	<br><br>
	<div class="row-fluid">
		<img src="media/com_thorhospedaje/images/posaderos/ruta_completado.png" />
	</div>
	<div class="row-fluid" style="margin-top: 11%;">
		<img src="media/com_thorhospedaje/images/posaderos/completado.png" />
	</div>

<h2><?php echo JText::_('TH_POSADERO_COMPLETADO_MESSAGE_TITLE'); ?></h2>

<div class="row-fluid box" style="margin-bottom: 5%; margin-top: 5%; text-align:justify; padding:2% !important;">
	<?php echo JText::_('TH_POSADERO_COMPLETADO_TEXT'); ?>
</div>

<div class="row-fluid">
		<a href="" target="_self">
			<img style=" display: block; margin: 0 auto 0 auto; width:25%; " src="media/com_thorhospedaje/images/comunes/home.png"/>
		</a>
</div>
